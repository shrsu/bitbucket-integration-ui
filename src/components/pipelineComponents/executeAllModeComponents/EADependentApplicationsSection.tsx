...
const EADependentApplicationsSection: React.FC<Props> = ({ dependency }) => {
                  ...
                  {repo.error && (
                    <HoverCard>
                      <HoverCardTrigger asChild>
                        <div className="text-red-600 dark:text-red-400 cursor-default">
...
export default EADependentApplicationsSection;
